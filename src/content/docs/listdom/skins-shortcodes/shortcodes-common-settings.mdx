...
<Aside type="note">
If you have created custom single listing templates or use Listdom Pro features, you might see additional layout options here. For example, Listdom <Badge text="Pro" /> allows assigning a specific single listing design per category or per listing, but those settings are managed elsewhere.
</Aside>
...
<Aside type="note">
The AJAX search feature is available if you have Listdom Pro or the appropriate add-on. <Badge text="Pro" />
</Aside>
...
<CardGrid>
    <Card>
        **Featured Cars Grid**: Create a shortcode that includes only listings labeled "Featured" and in the "Cars" category. Choose the Grid View skin with 3 columns, enable the Favorite icon, and use "Load More" pagination. Place this on your homepage to showcase featured cars.
    </Card>
    <Card>
        **Restaurant Map Directory**: Use the Half Map skin and include only the "Restaurants" category. Attach a search form that filters by cuisine and price range. In Map Controls, turn on Draw Controls and GPS Control so visitors can find restaurants in a specific area.
    </Card>
    <Card>
        **Agent Listings List**: For an agent's page, create a shortcode that includes only that author's listings. Use the List View skin and disable pagination to show all their listings at once. This will output a simple list of all properties by that agent.
    </Card>
</CardGrid>

<LinkCard href="https://demo.webilia.com/listdom/" target="_blank" title="Explore more shortcode examples and live demos on the Listdom demo site." />