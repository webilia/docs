...
**Import with Listdom Add-ons:** Utilize the Listdom CSV Add-on or Listdom Excel Add-on to import this data. During the import process, map the email addresses to the **listing owner** field to automatically assign ownership.  

<Aside type="note">
The CSV and Excel import options are available through the Listdom Add-ons.
</Aside>
