...
4. **Enable Lightbox for Listing Links:**  
   - In the shortcode settings, go to the Layout tab and locate the **Listing Link** option.  
...
By integrating the lightbox feature into your Listdom directory, you can significantly improve the functionality and user experience of your website. For more information about the lightbox and its functionality, refer to this [blog post](https://listdom.net/blog/what-is-a-lightbox-in-wordpress/).
