...
Follow the instructions on creating a [Single Map Shortcode](/listdom/skins-shortcodes/single-map-view-shortcode/). This step involves setting up the map’s appearance, the default location, and the type of listings that will be displayed.
