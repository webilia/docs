...
[How to Create a Map Shortcode?](/listdom/skins-shortcodes/shortcodes-common-settings/)
...
Create a search form that users can interact with. Instructions on how to create a search form are available in the [Search and Filter Builder guide](/listdom/search-filtering/create-search-filter-form/). Customize the form fields according to the criteria that are relevant to your listings, such as location, category, price range, etc.
