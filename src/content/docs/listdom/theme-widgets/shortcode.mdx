...
<CardGrid>
  ...
  <Card>
    **Featured Listings Slider in Footer:** Use Listdom Pro <Badge text="Pro" /> to create a shortcode with the **Slider** skin showing "Featured" listings. Place the Shortcode widget in your footer widget area and select that shortcode. Your site's footer will then display a rotating slider of featured listings.
  </Card>
  <Card>
