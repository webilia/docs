...
- **Reviews Add-on** - If using the _Reviews_ add-on, you might include a "minimum rating" filter in your search form. The widget will then let users filter listings by review ratings.
...
<CardGrid>
  ...
  <Card>
    **Homepage Filter Section:** Some themes have a full-width widget area on the homepage. You could add the Search widget there with a comprehensive search form (including date pickers from the Booking add-on <Badge text="Pro" />, for example). Visitors on the homepage can immediately search with advanced options like availability dates.
  </Card>
</CardGrid>
