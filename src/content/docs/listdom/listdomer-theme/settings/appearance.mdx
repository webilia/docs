...
- **Archive Page Titles:** [Include Context in Title](/vertex/widgets/dynamic-posts-templates/archive-title/) - e.g., show "Category: Travel" vs just "Travel" as the archive title.
...
<CardGrid>
  ...
  <Card title="Minimal Page Header">
    <Aside type="tip">Disable "Enable Shapes" in *Page Heading* and set a solid background color for a clean banner.</Aside>
  </Card>
</CardGrid>
...
- [Content Misc](/listdom/listdomer-theme/settings/content-misc/)
