...
Add this widget to a [Footer widget area](/listdom/listdomer-theme/widgets/widget-areas/) to create a "Contact us" column. In Appearance > Widgets, add (Listdomer) Contact to your desired sidebar, give it a Title, and fill in your contact info.
