---
title: Installation & Setup - Listdomer Theme
...
3. **Customize Site Identity:** In Appearance > Customize, set your Site Title, Tagline, and upload a site icon (favicon) as needed. Listdomer also allows uploading a logo via its theme options (see General Settings in the Settings guide).
</Steps>
