...
- **Background Color 2**: Secondary background color, used for gradients or hover transitions. (Default: `#306be6`)
...
<Aside type="note">
This section appears only if the price component is enabled in Listdom.
</Aside>
...
<CardGrid>
  <Card title="Applying a Custom Color Scheme">
    A real estate directory wants to match Listdom’s colors to its brand. Using the Customizer, the admin changes the General Color to the company’s purple hue and sets the Primary Font to a more formal serif font. As a result, all buttons and highlights on the site adopt the new purple tone for a consistent brand feel.
  </Card> 
  <Card title="Personalizing User Profiles">
    A directory site uses front-end profiles for its members. The admin adds a light gray background to profile sections and increases the padding, making pages look like distinct cards. They also adjust the Bio text color to a darker shade for better contrast, giving profiles a clean appearance that blends with the site’s theme.
  </Card>
</CardGrid>