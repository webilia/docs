...
sidebar_label: "Frontend Dashboard"
...
<CardGrid>
  <Card title="Enabling Guest Listing Submissions">
    To allow visitors to submit listings without registering, go to **Guest Submission**, turn **Status** on, and set **User Registration** to `Once Submitted`. This lets guests post listings easily while creating an account for them automatically.
  </Card>
  <Card title="Adding a Custom Support Page">
    To add a "Support" menu, go to **Dashboard Menus** and click **Add Custom Menu**. Set the label to "Support," choose an icon, and paste a contact form shortcode into the Content area. Now users can contact you directly from their dashboard.
  </Card>
  <Card title="Restricting Price Input to Admins Only">
    To ensure only staff can assign prices, go to **Modules**, find the **Price Options** module, and set it to `Editor + Admin`. The price fields will now only appear on the Add Listing form for users with Editor or Administrator roles.
  </Card>
</CardGrid>

<LinkCard title="Learn more about WordPress user roles and capabilities" href="https://wordpress.org/documentation/article/roles-and-capabilities/" />