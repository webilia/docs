...
<CardGrid>
  ...
  <Card>
    **Tag Cloud List:**  
    You can even use this shortcode for tags. E.g., `\[listdom_terms taxonomy="listdom-tag" show_count="0"\]` will produce a simple list of all listing tags (flat list, since tags have no hierarchy). This is akin to a tag cloud (though not weighted by count in styling).
  </Card>
</CardGrid>
