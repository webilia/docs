...
sidebar_label: Categories Shortcode
...
<CardGrid>
  ...
  <Card>
    **Top Categories Carousel:**  
    To highlight popular categories in a homepage section, you can use `\[listdom_category style="carousel" limit="5"\]`. This will show up to 5 categories in a sliding carousel. (Additional categories beyond 5 will be accessible via carousel navigation.)
  </Card>
  <Card>
