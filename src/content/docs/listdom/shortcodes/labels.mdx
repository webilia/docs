...
sidebar_label: Labels Shortcode
...
<CardGrid>
  <Card>
    **Simple Label List:**  
    `\[listdom_label style="simple" show_count="1"\]` will display all labels in a straightforward list (multiple columns) and include the number of listings in each label. This could be used in a sidebar to show a “tag cloud”-like list of labels.
  </Card>
  <Card>
