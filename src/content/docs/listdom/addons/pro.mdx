...
2. **Configure Settings:** Go to **Listdom > Settings**. You'll notice new tabs like **Frontend Dashboard** and additional options in **Single Listing** settings due to Pro. Adjust the settings:
