...
description: Step-by-step guide to install the Listdom core plugin and its add-ons.
categories: ["listdom","installation"]     # change for theme/addons
primary_category: "installation"
demo_url:
demo_name:
mirror_intercom: false
updated_from_pr:
---
...
Make sure **Listdom Core** is installed and your license is active.
</Aside>
...
## Troubleshooting
- If activation fails, verify the license in **Listdom → Settings → License**.
- Deactivate/Reactivate to reset.
- Clear cache if UI doesn’t update.

Screenshot placeholders
Replace these URLs later with your final CDN image links
![Plugins screen showing an activated add‑on](https://cdn.webilia.com/listdom/installation/activate-addons/step-01.png "Replace this URL")
