...
The Labelize Addon allows you to monetize listing labels (e.g., "Featured", "Verified") by integrating with WooCommerce. You can attach a price to these labels and let listing owners purchase them for their listings.
