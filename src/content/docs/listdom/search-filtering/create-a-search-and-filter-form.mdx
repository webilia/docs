...
4. **Available Fields:** You can drag and drop fields into rows to create the form. When you add a field to a search form, you can choose how it will be displayed. For example, you can select that categories should be shown as a drop-down list or as a checkbox. Read more about the [Search and Filter Form Available Fields](./search-and-filter-form-available-fields.mdx).
