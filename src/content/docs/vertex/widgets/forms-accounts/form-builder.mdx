...
- **Multi-Step Forms:** Break long forms into steps (pages) for better user experience <Badge text="Pro" variant='caution' />. Simply insert a "Step" field to start a new page in the form.
- **File Uploads:** Allow users to upload files via your form (e.g. for resumes or images) <Badge text="Pro" variant='caution' />.
- **Spam Protection:** Add a reCAPTCHA v3 field to protect against spam submissions <Badge text="Pro" variant='caution' />.
...
Some advanced field types (Multi-Step, File Upload, reCAPTCHA) are marked as <Badge variant='caution' text="Pro" /> and require Vertex Pro to function. If you include these fields in the free version, a prompt may remind you to upgrade.
</Aside>
...
- [Forms Accounts](/vertex/widgets/forms-accounts/)
