...
**Widgets in this category include:**

- **Site Logo:** Display your website's logo and optionally link it to the homepage.
- **Site Title:** Show your site's name as a heading, which can dynamically update from your WordPress settings.
- **Advanced Menus:** Add customizable navigation menus (horizontal, vertical, or hamburger menu) using your WordPress menu items.
- **Offcanvas Menu (Sidebar):** Create a collapsible side menu that slides in on click - great for mobile navigation or additional hidden menus.
- **Breadcrumb:** Display a breadcrumb trail for pages/posts, helping users navigate back through your site's hierarchy.
- **Search Input (Live/Ajax):** Insert a search bar so visitors can search your site, with an option for live Ajax results.
...
<Aside>**When to Use These Widgets:** Typically, you'll use Site Logo, Site Title, and Advanced Menus together in a header template to form a classic website header. The Offcanvas Menu is perfect for mobile-friendly navigation or secondary menus. Breadcrumbs are often placed below page headers or in dynamic templates to enhance UX, and the Search Input can be placed in headers or sidebars for easy access.</Aside>
