---
title: Lite vs Pro
description: Compares the free and Pro versions of Vertex Addons and outlines the extra widgets and tools unlocked in Pro.
sidebar:
  order: 3
---
...
## Advanced Tools & Capabilities in Pro <Badge text="Pro" variant='caution' />
...
<Aside>All extensions (Custom CSS/JS, Scroll to Top, Wrapper Link, etc.) are included in the free version. Pro unlocks the additional features above.</Aside>


## See also

- [Installation](/vertex/getting-started/installation/)
