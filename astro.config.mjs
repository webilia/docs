      ...
      sidebar: [
        {
          ...
          items: [
            ...
            { label: 'How to Start with Listdom?', autogenerate: { directory: 'listdom/how-to-start' } },
            { label: 'Installation', autogenerate: { directory: 'listdom/installation' } },
            { label: 'Settings', autogenerate: { directory: 'listdom/settings' } },
            { label: 'Taxonomies', autogenerate: { directory: 'listdom/taxonomies' } },
            { label: 'Listings', autogenerate: { directory: 'listdom/listings' } },
            { label: 'Listdom Shortcodes', autogenerate: { directory: 'listdom/shortcodes' } },
            { label: 'Search & Filter Form', autogenerate: { directory: 'listdom/search-filter-form' } },
            { label: 'Listdom Frontend Dashboard', autogenerate: { directory: 'listdom/frontend-dashboard' } },
            ...
            { label: 'Addons Documentation', autogenerate: { directory: 'listdom/addons' } },
          ],
        },
        {
          label: 'Vertex Addons',
